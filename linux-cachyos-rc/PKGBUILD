...
#    "${_patchsource}/TT/0001-tt-r2-5.16.patch"
  "${_patchsource}/misc/0001-block-5.16.patch"
  "${_patchsource}/0001-apparmor.patch"
  "${_patchsource}/0001-mapple.patch"
  "${_patchsource}/0001-damon.patch"
#  "${_patchsource}/0001-umcg.patch"
  "${_patchsource}/0001-misc.patch"
  "${_patchsource}/0001-bbr2.patch"
  "${_patchsource}/0001-cpu-patches.patch"
  "${_patchsource}/0001-zstd-patches.patch"
  "${_patchsource}/misc/0001-mm.patch"
  "${_patchsource}/0001-zen-patches.patch"
  "${_patchsource}/0001-winesync-fsync.patch"
  "https://raw.githubusercontent.com/ptr1337/kernel-patches/master/5.15/AMD/0001-amd-pstate-dev-v5-fixes.patch"
...
md5sums=('c3b864c2edd20351f8fbfa265df89508'
         '0ac42c66359097d484fc67a1905008b0'
         'ed2a1bd6ccb62423dca67821baf836e1'
         'e8e38f00f1f33ed66e16d3df996ad1d9'
         '049da61c4dcabfc5130940a0c734b1e0'
         '04c5f310615c227be04f20123412eed6'
         ...
         '13ed4ea506b1dc0e9e8437d34c99a916'
