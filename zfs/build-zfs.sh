#!/usr/bin/env bash
docker run --name kernelbuild-zfs -e EXPORT_PKG=1 -v $PWD:/pkg -v /home/ptr1337/ccache-kernel:/home/notroot/ccache pttrr/docker-makepkg-kernel-zfs
docker rm kernelbuild-zfs
docker run --name kernelbuild-zfs -e EXPORT_PKG=1 -v $PWD:/pkg -v /home/ptr1337/ccache-kernel:/home/notroot/ccache pttrr/docker-makepkg-kernel-zfs-v3
docker rm kernelbuild-zfs

find . -name "PKGBUILD" | xargs -I {} sed -i "s/_pkgcore=cachyos/_pkgcore=cachyos-bore/" {}
docker run --name kernelbuild-zfs-zfs -e EXPORT_PKG=1 -v $PWD:/pkg -v /home/ptr1337/ccache-kernel:/home/notroot/ccache pttrr/docker-makepkg-kernel-zfs
docker rm kernelbuild-zfs
docker run --name kernelbuild-zfs -e EXPORT_PKG=1 -v $PWD:/pkg -v /home/ptr1337/ccache-kernel:/home/notroot/ccache pttrr/docker-makepkg-kernel-zfs-v3
docker rm kernelbuild-zfs
