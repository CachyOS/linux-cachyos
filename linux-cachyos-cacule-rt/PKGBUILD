...
if [ "$_cpusched" = "cacule" ]  && [ -n "$_use_llvm_lto" ]; then
  pkgbase=linux-cachyos-cacule-rt-lto
elif  [ "$_cpusched" = "rdb" ] && [ -n "$_use_llvm_lto" ]; then
  pkgbase=linux-cachyos-cacule-rdb-rt-lto
elif [ "$_cpusched" = "cacule" ]; then
  pkgbase=linux-cachyos-cacule-rt
elif [ "$_cpusched" = "rdb" ]; then
  pkgbase=linux-cachyos-cacule-rdb-rt
fi
pkgver=5.15.2
pkgrel=1
...
source=("https://cdn.kernel.org/pub/linux/kernel/v${pkgver:0:1}.x/linux-${pkgver}.tar.xz"
  "config"
  "${_patchsource}/RT/0001-5.15.2-rt19.patch"
  "${_caculepatches}/v5.15/cacule-5.15-rt-full.patch"
...
md5sums=('4e0f11f01e157a3d8d7a63c72bedb96f'
         '1782aa1320baf4333ccd69fdc52bafa4'
         'ba39e545fe34ef17fc88f954d54b5645'
         '690fe365432d3368cc4ba73578d50494'
         'cf26387aadf2a90428350ac246b070c9'
         '8b5d5c105d2f93e46b000b954aa812bc'
         '681cc53e18c8557644166f7f94d9e23f'
         '80e419d6847d4122a23a141fd3a40e52'
         '53f037488a66667220c263f92ded333d'
         '2a8097ba46be56fbbe3967e9c34c9a0b'
         'e81a7c896e104ff9206ab51efd30e554'
         'd7f5fefd8ae018999e2b55073aaca706'
         '4792a194feb0e9267f8660f38746f4fb'
         'ff2c6319fb660962609e2c8d43eab654'
         'fb3f67bb491a4f8ed3ef3121383deb25'
         '6038177c72982533035309fcd6df208a'
         '640629cbf3f32c33b6a3657ca766bb2c'
         '9790a691cd9fabf9148a0b7787c141f0'
         'a1c6a106ddbbff6be6711f6a72706cb0'
         'eb53a23a8d4ff4990d7040e5037e8a06'
         'd6e5581b4fade267a28deb8e73d236f5'
         '39c65dd4eeec0dfedbf79ca5e43276d5'
         '19e4c2a45a1337502ce081b337a896bf'
         'bc64b1d1a9c95b07c28457f7214ebf81'
         '4e4d84a2759740ec1856392f5b98de12'
         '8cb0301d159b59727b7bdd09350e2a9f'
         'de6db1147385c058b2e94df3c1739fdf'
         'bf58290793d3a095ef95fb1fac2de89a'
         '85137d3d62dd3c5dd0d5b8ee015eef25'
